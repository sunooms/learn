...
class Flow : public Module
{
    public:
        ...
        virtual RESULT GlobalInit(Session* sessin) const =0 ;
        virtual RESULT GlobalExit(Session* sessin) const =0 ;

        virtual RESULT ProcessRequest(Session*) const = 0;
        virtual RESULT ProcessEndRequest(Session* sessin) const = 0 ;
